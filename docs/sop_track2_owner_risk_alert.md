...
**Version:** 1.0  
**Applicable Vehicle:** Mitsubishi Outlander, Eclipse Cross, Xpander (2020 onwards)  
...
segera jadwalkan servis di bengkel resmi Mitsubishi terdekat.
```
...
TINDAKAN: Jadwalkan servis di bengkel resmi Mitsubishi dalam 7 hari.
...
2. Matikan mesin
3. Hubungi layanan darurat Mitsubishi: 1-500-989
...
3. Sends an alert to the nearest authorised Mitsubishi workshop
...
No push notification is sent when all sensors are within normal range. This is a deliberate design choice — alert fatigue reduces owner responsiveness. Silence means the vehicle is healthy. Owners can view their vehicle health history at any time in the Mitsubishi owner portal.
